...
const stream_types = @import("webtransport_streams.zig");
...
pub const WebTransportSession = struct {
    const StreamTypes = stream_types.StreamTypes(@This());
    pub const Stream = StreamTypes.Stream;
    pub const StreamDataHandler = StreamTypes.StreamDataHandler;
